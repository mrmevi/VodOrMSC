...
name: "DirectionAboutUsComponent"
})
</script>

<template>
    <div class="xl:hidden mx-auto max-w-[1280px]">
        <div class="">
            <div class="text-center max-w-[1280px] mx-auto">
                <h1 class="mb-6  font-sans font-bold text-xl sm:text-3xl">Спортивыне мероприятия</h1>
                <h2 class="mb-6 text-justify lg:text-center font-sans font-bold text-1xl">
                    Организация спортивных мероприятий и продвижение здорового образа жизни – важная часть общественного движения.
                </h2>
                <p class="mb-6 text-justify font-sans text-sm sm:text-base indent-8">
        ...
        <div class="">
            <div class="mt-8 text-center max-w-[1280px] mx-auto">
                <h1 class="mb-6 font-sans font-bold text-xl sm:text-3xl">Военно-патриотическое воспитание</h1>
                <h2 class="mb-6 text-justify lg:text-center font-sans font-bold text-1xl ">
                    В наше время важным аспектом образования является военно-патриотическое воспитание, как необходимый аспект формирования гражданской идентичности.
                </h2>
                <p class="mb-6 text-justify font-sans text-sm sm:text-base indent-8">
    ...
    <div class="mx-auto max-w-[1280px] mt-12 max-xl:hidden">
        <div class="mb-8 flex space-x-8">
            <div class=" w-1/2 my-auto max-w-[1280px] mx-8 mr-12">
                <h1 class="mb-6 font-sans font-bold text-3xl">Спортивыне мероприятия</h1>
                <h2 class="mb-6 text-justify font-sans font-bold text-1xl ">
                    Организация спортивных мероприятий и продвижение здорового образа жизни – важная часть общественного движения.
                </h2>
                <p class="mb-6 text-justify font-sans text-base indent-8">
                    Спорт объединяет нас и делает нашу жизнь более насыщенной и интересной. Кроме того, спортивные мероприятия становятся отличным поводом для общения и новых знакомств. Участники этих событий делятся опытом, поддерживают друг друга, помогают в достижении поставленных целей.
                </p>
            </div>
